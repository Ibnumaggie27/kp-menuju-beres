    ...
    <div class="container">
        <div class="row mb-5">
            <div class="col-md-6 pt-md-5 mb-3 text-center text-md-start">
                ...
                <h4>Mari Kita Sukseskan Pemilihan Ketua Osis <br> SMKN 1 Karangtengah</h4>
            ...
            <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <div class="modal-content">
                    ...
                    <h1 class="modal-title fs-5" id="exampleModalLabel">Form Isian Untuk Kandidat</h1>
            ...
            <div class="col-md-6">
                <img src="{{ asset('image/pemilih.gif') }}" alt="" srcset="" class="w-100">
            </div>
        </div>
        <div class="row pt-5">
