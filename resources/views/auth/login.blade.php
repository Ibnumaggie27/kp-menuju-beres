...
<div class="row h-100 justify-content-center">
    <div class="col-lg-6 col-12">
        <div id="auth-left">
            ...
            <!-- <a href="index.html" style="display: block; position: relative; width: 35%;">
  <img src="{{ asset('image/loginchar.png') }}" alt="Logo" style="width: 100%; height: auto; position: absolute; top: 1%; left: 200%;">
</a> -->

            </div>
            <h1 class="auth-title">Login Pemilih</h1>
