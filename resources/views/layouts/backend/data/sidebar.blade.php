...
<ul class="menu">
    ...
    <li
        class="sidebar-item  ">
        <a href="{{ route('backend.dashboard') }}" class='sidebar-link' style="color: var(--bs-dark-text);">
  ...
  <li
  class="sidebar-item  ">
  <a href="{{ route('backend.config.index') }}" class='sidebar-link' style="color: var(--bs-dark-text);">
